<form name="myForm" class="form-horizontal">
    ...
    <div class="control-group" ng-class="{error: myForm.name.$invalid}">
        ...
        <div class="controls">
            <input class="input-xlarge" type="text" name="name" id="name" ng-model="book.name" required>
    ...
    <div class="control-group" ng-class="{error: myForm.site.$invalid}">
        ...
        <div class="controls">
            <input class="input-xlarge" type="url" name="site" id="site" ng-model="book.site" required>
    ...
    <div class="controls">
        <textarea class="input-xxlarge" name="description" id="description" ng-model="book.description"></textarea>
    </div>
    ...
    <div class="form-actions">
        ...
        <a href="<?php echo site_url('book#/'); ?>" class="btn btn-link">Cancel</a>
        <button ng-click="desrtoy()" ng-show="book.id" class="btn btn-danger pull-right"><i class="icon-trash icon-white"></i> Delete</button>
    </div>
